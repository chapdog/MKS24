...
static void MX_GPIO_Init(void)
{
	...
	/**/
	LL_GPIO_SetPinPull(S_2_GPIO_Port, S_2_Pin, LL_GPIO_PULL_UP);

	/**/
	LL_GPIO_SetPinMode(B1_GPIO_Port, B1_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(S_2_GPIO_Port, S_2_Pin, LL_GPIO_MODE_INPUT);
	...
	/**/
	GPIO_InitStruct.Pin = S_1_Pin;
	GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
	GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
	LL_GPIO_Init(S_1_GPIO_Port, &GPIO_InitStruct);
